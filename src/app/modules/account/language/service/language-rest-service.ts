...
import {LanguageModel as M} from "../model/language-model";
import {LanguageSearchModel as SM} from "../model/language-search-model";
import {LookupModel as LM} from "../../../guide-assistant/common/model/lookup-model";

@Injectable({
    providedIn: 'root'
})
export class LanguageRestService extends BaseRestService {

    constructor(public override httpClient: HttpClient) {
        super(httpClient, EndpointConstant.LANGUAGE_SERVICE_NAME);
    }
