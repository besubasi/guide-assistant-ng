...
import {CountryModel as M} from "../model/country-model";
import {CountrySearchModel as SM} from "../model/country-search-model";
...
export class CountryRestService extends BaseRestService {
    ...
    constructor(public override httpClient: HttpClient) {
        super(httpClient, EndpointConstant.COUNTRY_SERVICE_NAME);
    }
