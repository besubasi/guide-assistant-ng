...
import {ActivityCompanyModel as M} from "../model/activity-company-model";
import {ActivityCompanySearchModel as SM} from "../model/activity-company-search-model";
import {LookupModel as LM} from "../../common/model/lookup-model";

@Injectable({
    providedIn: 'root'
})
export class ActivityCompanyRestService extends BaseRestService {

    constructor(public override httpClient: HttpClient) {
        super(httpClient, EndpointConstant.ACTIVITY_COMPANY_SERVICE_NAME);
    }
