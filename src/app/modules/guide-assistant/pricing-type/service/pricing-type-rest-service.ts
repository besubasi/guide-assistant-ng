...
import {PricingTypeModel as M} from "../model/pricing-type-model";
import {PricingTypeSearchModel as SM} from "../model/pricing-type-search-model";
import {LookupModel as LM} from "../../common/model/lookup-model";

@Injectable({
    providedIn: 'root'
})
export class PricingTypeRestService extends BaseRestService {

    constructor(public override httpClient: HttpClient) {
        super(httpClient, EndpointConstant.PRICING_TYPE_SERVICE_NAME);
    }
