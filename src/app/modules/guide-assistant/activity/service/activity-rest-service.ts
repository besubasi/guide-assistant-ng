...
import {ActivityModel as M} from "../model/activity-model";
import {ActivitySearchModel as SM} from "../model/activity-search-model";
import {LookupModel as LM} from "../../common/model/lookup-model";

@Injectable({
    providedIn: 'root'
})
export class ActivityRestService extends BaseRestService {

    constructor(public override httpClient: HttpClient) {
        super(httpClient, EndpointConstant.ACTIVITY_SERVICE_NAME);
    }
