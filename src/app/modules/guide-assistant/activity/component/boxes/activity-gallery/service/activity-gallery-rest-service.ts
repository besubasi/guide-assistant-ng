...
import {ActivityGalleryModel as M} from "../model/activity-gallery-model";

@Injectable({
    providedIn: 'root'
})
export class ActivityGalleryRestService extends BaseRestService {

    constructor(public override httpClient: HttpClient) {
        super(httpClient, EndpointConstant.ACTIVITY_GALLERY_SERVICE_NAME);
    }
    ...
    public getListByActivityId(activityId: number): Observable<Array<M>> {
        return this.httpClient.get<ApiResponse>(this.ENDPOINT_GET_LIST_BY_ACTIVITY_ID + activityId)
