...
import {ActivityCompanyRelModel as M} from "../model/activity-company-rel-model";
import {ActivityCompanyRelSaveModel as SV} from "../model/activity-company-rel-save-model";
import {ActivityCompanyRelSearchModel as SM} from "../model/activity-company-rel-search-model";
...
export class ActivityCompanyRelRestService extends BaseRestService {

    constructor(public override httpClient: HttpClient) {
        super(httpClient, EndpointConstant.ACTIVITY_COMPANY_REL_SERVICE_NAME);
    }
